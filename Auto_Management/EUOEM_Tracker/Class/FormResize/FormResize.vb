...
Public Class Resizer
    ...
    Public Sub FindAllControls(thisCtrl As Control)
        ...
        For Each ctl As Control In thisCtrl.Controls
            Try
                If Not IsNothing(ctl.Parent) And Not String.IsNullOrEmpty(ctl.Name) And Not ctl.Name = "lnkClear" And Not ctl.Name = "_horizontal" And Not ctl.Name = "_vertical" Then
